...
solve fails to converge in `tests/MMWSpalling/validation/hu/hu_spall_onset/input_{granite2,sandstone2}`
...
All under [`tests/MMWSpalling/validation/hu/hu_spall_onset/diag/`](./diag/) — never touch
...
plot_file=tests/MMWSpalling/validation/hu/hu_spall_onset/output/diag_<probe_name>`.
...
| [`tests/MMWSpalling/validation/hu/hu_spall_onset/AMR_FAILURE_ANALYSIS.md`](AMR_FAILURE_ANALYSIS.md) | This section 9. | Kept |
...
mpirun --oversubscribe --bind-to none -np 1 \
  ...
  tests/MMWSpalling/validation/hu/hu_spall_onset/diag/input_sandstone2_base \
  el.solver.verbose=2
